            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="relative">
                  ...
                  <input
                    type="text"
                    placeholder="Entreprise, dirigeant, SIREN/SIRET..."
                    value={searchQuery}
                    onChange={(e) => searchInRealTime(e.target.value)}
                    className="pl-10 pr-12 py-2 border border-[#bdc3c7] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#3498db] w-96"
                    title="Recherche intelligente : tapez un nom d'entreprise, un dirigeant (ex: Michel Dubois), ou un SIREN/SIRET"
                  />
                  {searchQuery && (
                    <button
                ...
                {searchQuery && searchQuery.split(/\s+/).length >= 2 && (
                  <div className="flex items-center gap-1 px-2 py-1 bg-[#e8f5e8] text-[#27ae60] rounded text-xs">
                    <Users className="h-3 w-3" />
                    <span>Recherche dirigeants incluse</span>
                  </div>
                )}
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-[#1976d2] mb-4">
                          Tapez le nom d'une entreprise, d'un dirigeant (ex: "Michel Dubois"), ou un SIREN/SIRET pour voir les résultats s'afficher automatiquement.
                        </p>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                          ...
                          <div className="flex items-center gap-2 text-[#1976d2]">
                            ...
                            <span>Recherche par dirigeant (prénom + nom)</span>
                          </div>
                          <div className="flex items-center gap-2 text-[#1976d2]">
                            <FileText className="h-4 w-4" />
                            <span>SIREN/SIRET et résultats complets</span>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        {/* Indicateur de recherche intelligente */}
                        {searchQuery && searchQuery.split(/\s+/).length >= 2 && (
                          <span className="ml-2 text-xs bg-[#e8f5e8] text-[#27ae60] px-2 py-1 rounded">
                            Recherche unifiée : entreprises + dirigeants
                          </span>
                        )}
                      </div>
                    ...
                    <table role="grid" className="w-full">
                      <thead className="bg-[#f8f9fa] border-b border-[#bdc3c7]">
                        <tr>
                          ...
                          <th className="px-4 py-3 text-left text-sm font-medium text-[#2c3e50]">Dirigeants</th>
                            ...
                            <td className="px-4 py-3">
                              {company.dirigeants && company.dirigeants.length > 0 ? (
                                <div className="space-y-1">
                                  {company.dirigeants.slice(0, 2).map((dirigeant, idx) => (
                                    <div key={idx} className="flex items-center gap-1 text-xs">
                                      <Users className="h-3 w-3 text-[#7f8c8d]" />
                                  ...
                                  {company.dirigeants.length > 2 && (
                                    <div className="text-xs text-[#7f8c8d]">
                                      +{company.dirigeants.length - 2} autre{company.dirigeants.length > 3 ? 's' : ''}
                                    </div>
                                  )}
                                </div>
                              ) : (
                                <span className="text-xs text-[#7f8c8d]">Non renseigné</span>
                              )}
                            </td>
                            <td className="px-4 py-3">
                              {company.siege ? (
                        ...
                        <div>
                          ...
                          <div className="space-y-3">
                            {selectedCompany.dirigeants.map((dirigeant, idx) => (
                              <div key={idx} className="p-3 border border-[#ecf0f1] rounded-lg">
                                ...
                                {dirigeant.qualite && (
                                  <p className="text-xs text-[#7f8c8d] mb-1">
                                    <strong>Qualité:</strong> {dirigeant.qualite}
                                  </p>
                                )}
                                {dirigeant.dateNaissance && (
                                  <p className="text-xs text-[#7f8c8d] mb-1">
                                    <strong>Date de naissance:</strong> {dirigeant.dateNaissance}
                                  </p>
                                )}
                                {dirigeant.nomUsage && dirigeant.nomUsage !== dirigeant.nom && (
                                  <p className="text-xs text-[#7f8c8d]">
                                    <strong>Nom d'usage:</strong> {dirigeant.nomUsage}
                                  </p>
                                )}
                                {dirigeant.pseudonyme && (
                                  <p className="text-xs text-[#7f8c8d]">
                                    <strong>Pseudonyme:</strong> {dirigeant.pseudonyme}
                                  </p>
                                )}
                              </div>
                            ))}
