...
const ProductCard = ({ product }: { product: Product }) => {
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'IN_STOCK':
        return 'bg-[#d5f4e6] text-[#27ae60] border-[#a9dfbf]';
      case 'LOW_STOCK':
        return 'bg-[#fdeaa7] text-[#f39c12] border-[#f7dc6f]';
      case 'OUT_OF_STOCK':
        return 'bg-[#fadbd8] text-[#e74c3c] border-[#f1948a]';
      default:
        return 'bg-[#ecf0f1] text-[#34495e] border-[#bdc3c7]';
    }
  };
  ...
  return (
    <motion.div
      ...
      transition={{ duration: 0.5, ease: [0.25, 0.46, 0.45, 0.94] }}
      className="rounded-xl border border-[#bdc3c7] bg-[#ecf0f1] p-4 transition-all duration-300 hover:shadow-lg"
    >
      ...
      <div className="space-y-4">
        <div>
          ...
          <input
            ...
            className="font-open-sans w-full rounded-xl border border-[#bdc3c7] bg-white px-3 py-2 focus:border-[#2c3e50] focus:ring-2 focus:ring-[#2c3e50]"
    ...
    const loadData = async () => {
      ...
      try {
        if (stockMode === 'internal') {
          ...
          const mockMovements = generateMockMovements(50);
          ...
          const odooAPI = new MockOdooAPI(odooConfig);
          ...
          <div className="flex flex-col gap-4 lg:flex-row">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="font-open-sans w-full rounded-xl border border-[#bdc3c7] bg-white py-3 pl-10 pr-4 focus:border-[#2c3e50] focus:ring-2 focus:ring-[#2c3e50]"
              />
            </div>
            ...
            <div className="flex gap-3">
              ...
              <button className="font-open-sans flex items-center gap-2 rounded-xl border border-[#bdc3c7] bg-white px-4 py-3 font-medium transition-colors hover:bg-[#ecf0f1]">
        ...
        <div className="rounded-2xl border border-[#bdc3c7] bg-[#ecf0f1] p-6 shadow-xl">
          <div className="mb-6 flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <button className="font-open-sans flex items-center gap-2 rounded-xl border border-[#bdc3c7] bg-white px-3 py-2 text-sm font-medium transition-colors hover:bg-[#ecf0f1]">
