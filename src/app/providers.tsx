    ...
    <ClerkProvider
      ...
      appearance={{
        ...
        elements: {
          ...
          formButtonPrimary: 'bg-gradient-to-r from-blue-600 to-purple-600 hover:opacity-90 transition-opacity text-sm normal-case',
          headerTitle: 'text-3xl font-bold text-gray-800',
          headerSubtitle: 'text-gray-500',
          socialButtonsBlockButton: 'border-gray-200 hover:bg-gray-50',
          footerActionLink: 'text-blue-600 hover:text-blue-700 font-semibold',
          dividerLine: 'bg-gray-200',
          formFieldInput: 'rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 border-gray-300'
        },
      }}
    >
      {children}
